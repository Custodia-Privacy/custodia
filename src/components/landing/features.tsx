      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group rounded-xl border border-slate-200 bg-white p-6 transition-all hover:border-navy-200 hover:shadow-lg dark:border-slate-800 dark:bg-slate-900 dark:hover:border-navy-700"
            >
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-navy-50 text-navy-600 transition-colors group-hover:bg-navy-100 dark:bg-navy-950/50 dark:text-navy-400">
                <svg
                  className="h-5 w-5"
                  fill="none"
                  viewBox="0 0 24 24"
